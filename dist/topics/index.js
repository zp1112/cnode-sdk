...
var TOPICS = function (_BASE) {
  (0, _inherits3.default)(TOPICS, _BASE);
  ...
  function TOPICS(options) {
    ...
    actions.forEach(function (action) {
      _this[action] = _this[action.replace(/(\w)/, function (v) {
        ...
        var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(opts, to, callback) {
          return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _this.params = (0, _assign2.default)(_.BASE.options, opts);
                  return _context.abrupt('return', (0, _.sendRequest)('' + API + _list2.default[action].action, _this.params, { method: _list2.default[action].method, timeout: to }, callback));
